...
export default function createOperations(vm: VirtualMachine): Operations {
  ...
  // 1nnn - JP addr
  Op[0x1] = function JP_addr(opcode) {
    let { addr } = opcode;
  ...
  // 2nnn - CALL addr
  Op[0x2] = function CALL_addr(opcode) {
    let { addr } = opcode;
  ...
  // 3xkk - SE Vx, byte
  Op[0x3] = function SE_Vx_byte(opcode) {
    let { x, byte } = opcode;
  ...
  // 4xkk - SNE Vx, byte
  Op[0x4] = function SNE_Vx_byte(opcode) {
    let { x, byte } = opcode;
  ...
  // 5xy0 - SE Vx, Vy
  Op[0x5] = function SE_Vx_Vy(opcode) {
    let { x, y } = opcode;
  ...
  // 6xkk - LD Vx, byte
  Op[0x6] = function LD_Vx_byte(opcode) {
    let { x, byte } = opcode;
  ...
  // 7xkk - ADD Vx, byte
  Op[0x7] = function ADD_Vx_byte(opcode) {
  ...
  // 8xy0 - LD Vx, Vy
  Op0x8[0x0] = function LD_Vx_Vy(opcode) {
  ...
  // 8xy1 - OR Vx, Vy
  Op0x8[0x1] = function OR_Vx_Vy(opcode) {
  ...
  // 8xy2 - AND Vx, Vy
  Op0x8[0x2] = function AND_Vx_Vy(opcode) {
  ...
  // 8xy3 - XOR Vx, Vy
  Op0x8[0x3] = function XOR_Vx_Vy(opcode) {
  ...
  // 8xy4 - ADD Vx, Vy
  Op0x8[0x4] = function ADD_Vx_Vy(opcode) {
  ...
  // 8xy5 - SUB Vx, Vy
  Op0x8[0x5] = function SUB_Vx_Vy(opcode) {
  ...
  // 8xy6 - SHR Vx {, Vy}
  Op0x8[0x6] = function SHR_Vx(opcode) {
  ...
  // 8xy7 - SUBN Vx, Vy
  Op0x8[0x7] = function SUBN_Vx_Vy(opcode) {
  ...
  // 8xyE - SHL Vx {, Vy}
  Op0x8[0xE] = function SHL_Vx_Vy(opcode) {
  ...
  // 9xy0 - SNE Vx, Vy
  Op[0x9] = function SNE_Vx_Vy(opcode) {
  ...
  // Annn - LD I, addr
  Op[0xA] = function LD_I_addr(opcode) {
    I = opcode.addr;
  }

  // Bnnn - JP V0, addr
  Op[0xB] = function JP_V0_addr(opcode) {
  ...
  // Cxkk - RND Vx, byte
  Op[0xC] = function RND_Vx_byte(opcode) {
  ...
  Op[0xD] = function DRW_Vx_Vy_n(opcode) {
    let { x, y, lo: n } = opcode;
    let Vx = V[x];
    let Vy = V[y];
    V[0xF] = 0;
    for (let sy = 0; sy < n; sy++) {
      ...
      for (let sx = 0; sx < 8; sx++) {
        ...
        let px = (RAM[I + sy] >> (7 - sx)) & 0b00000001;
  ...
  // Fx15 - LD DT, Vx
  Op0xF[0x15] = function LD_DT_Vx(opcode) {
  ...
  // Fx18 - LD ST, Vx
  Op0xF[0x18] = function LD_ST_Vx(opcode) {
  ...
  // Fx1E - ADD I, Vx
  Op0xF[0x1E] = function ADD_I_Vx(opcode) {
  ...
  // Fx29 - LD F, Vx
  Op0xF[0x29] = function LD_F_Vx(opcode) {
  ...
  // Fx33 - LD BCD, Vx
  Op0xF[0x33] = function LD_BCD_Vx(opcode) {
    let { x } = opcode;
    let Vx = V[x];
  ...
  // Fx55 - LD [I], Vx
  Op0xF[0x55] = function LD_I_Vx(opcode) {
    let x = opcode.x;
  ...
  // Fx65 - LD Vx, [I]
  Op0xF[0x65] = function LD_Vx_I(opcode) {
    let x = opcode.x;
